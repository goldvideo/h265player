var MP4Box = (() => {
  ...
  // node_modules/mp4box/dist/mp4box.simple.js
  var mp4box_simple_exports = {};
  __export(mp4box_simple_exports, {
    Box: () => Box,
    BoxParser: () => BoxParser,
    FullBox: () => FullBox,
    ISOFile: () => ISOFile,
  ...
  var DataStream = class _DataStream {
    ...
    static nativeToEndian(typedArray, littleEndian) {
      if (littleEndian && _DataStream.ENDIANNESS === 2) {
        return typedArray;
      } else {
        return this.flipArrayEndianness(typedArray);
      }
  ...
  var simple_boxes_exports = {};
  __export2(simple_boxes_exports, {
    bxmlBox: () => bxmlBox,
    dinfBox: () => dinfBox,
    edtsBox: () => edtsBox,
    emsgBox: () => emsgBox,
  ...
  var BoxParser = registerBoxes(simple_boxes_exports);
  return __toCommonJS(mp4box_simple_exports);
})();
